local defaults = {
    ...
    TargetFrame = {
        ...
        X = 375,
        Y = 125,
        Bar1 = { Height = 20, BarType = "HB", LeftText = "[UnitName] [[Level]]", RightText = "[CurrHPSmart]/[MaxHPSmart] [PercHP]%%" },
        Bar2 = { Height = 10, BarType = "PB", LeftText = "[PercPower]%%", RightText = "[CurrPower]/[MaxPower]" },
        Bar3 = { Height = 5, BarType = "CB", LeftText = "", RightText = "" },
        Bar4 = { Height = 10, BarType = "EB", LeftText = "[UnitName]", RightText = "[Level]" },
        Bar5 = { Height = 0, BarType = "EB", LeftText = "", RightText = "" },
    },
    TargetOfTargetFrame = {
    ...
    PetFrame = {
        ...
        X = 0,
        Y = 0,
        Bar1 = { Height = 10, BarType = "EB", LeftText = "[UnitName]", RightText = "" },
        Bar2 = { Height = 15, BarType = "HB", LeftText = "[PercHP]%%", RightText = "[CurrHPSmart]" },
        Bar3 = { Height = 10, BarType = "PB", LeftText = "", RightText = "[CurrPowerSmart]" },
